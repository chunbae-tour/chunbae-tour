...
INSERT INTO festivals (
    id, created_at, updated_at, description, end_date, image_url, lat, lng,
    address, name, region, start_date, status, related_url
) VALUES
    (9201, NOW(6), NOW(6), '한강 야경과 푸드트럭, 버스킹을 함께 즐기는 봄맞이 로컬 축제입니다.',
     '2026-06-15', 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=1200',
     37.5269800, 126.9348300, '여의도 한강공원', '한강 달빛 야시장', '서울', '2026-06-01',
     'ACTIVE', NULL),
    (9202, NOW(6), NOW(6), '전통 등과 미디어아트가 어우러지는 야간 산책 행사입니다.',
     '2026-07-07', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=1200',
