...
import com.chunbaetour.domain.companion.event.CompanionScoreCacheEvictEvent;
...
import com.chunbaetour.domain.companion.type.CompanionStatus;
...
public class CompanionReviewService {
    ...
    @Cacheable(value = "companionScore:v2", key = "#userId")
