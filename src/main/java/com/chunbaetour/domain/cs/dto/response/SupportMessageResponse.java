...
/**
 * @param fileUrl IMAGE/FILE만 값 존재. SupportMessage.fileUrl(S3 객체 키)을 presigned GET URL로 변환한 값(KAN-309 CS) —
...
public record SupportMessageResponse(
    ...
    // resolvedFileUrl: IMAGE/FILE일 때 호출자가 SupportFileStorage.presignedGetUrl()로 변환해 전달(KAN-309 CS)
