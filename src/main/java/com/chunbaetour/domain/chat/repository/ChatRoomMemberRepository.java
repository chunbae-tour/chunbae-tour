...
public interface ChatRoomMemberRepository extends JpaRepository<ChatRoomMember, Long> {
    ...
    // 채팅방 상세 조회 — 현재 활동 중인 멤버만, 참여 순서(createdAt ASC, id ASC) 정렬
    List<ChatRoomMember> findByChatRoomIdAndMemberStateInOrderByCreatedAtAscIdAsc(Long chatRoomId, List<ChatMemberState> states);
}
