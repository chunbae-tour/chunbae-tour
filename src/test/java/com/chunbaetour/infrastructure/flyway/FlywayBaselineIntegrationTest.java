...
class FlywayBaselineIntegrationTest {
    ...
    void v1_applied_on_empty_db_creates_schema_and_records_success() {
        ...
        // V202606081843이 추가한 companions/companion_participants 테이블도 검증 (KAN-256 회귀 가드)
    ...
    void baseline_on_migrate_records_v1_as_baseline_without_executing_sql() {
        ...
        assertTableExists(jdbc, "companion_reviews");
        // V202606081843도 실 실행되어 companions/companion_participants 테이블 존재해야 함 (KAN-256 회귀 가드)
        assertTableExists(jdbc, "companions");
        assertTableExists(jdbc, "companion_participants");
    }
